...
const API_KATEGORI = "http://localhost:5000/api/daftar-pelatihan";
...
export default function DaftarPelatihan() {
  ...
  useEffect(() => {
    const loadKategori = async () => {
      try {
        // ambil kategori
        const kat = await axios.get("http://localhost:5000/api/kategori-pelatihan");

        // ambil daftar pelatihan
        const pel = await axios.get("http://localhost:5000/api/daftar-pelatihan");
                                  ...
                                  <button
                                    ...
                                    onClick={async () => {
                                      if (
                                        ...
                                        await axios.delete(
                                          `http://localhost:5000/api/daftar-pelatihan/${pel.id_pelatihan}`
                                        );
                                        loadKategori();
                                      }
                                    }}
