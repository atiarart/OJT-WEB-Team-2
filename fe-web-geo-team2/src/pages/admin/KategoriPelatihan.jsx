...
const API_URL = "http://localhost:5000/api/kategori-pelatihan";
...
export default function KategoriPelatihan() {
  ...
  const handleSubmit = () => {
    navigate("/admin/api/kategori-pelatihan-create")
  }

  const handleUpdate = (id) => {
    navigate(`/admin/api/kategori-pelatihan-edit/${id}`);
  };
  ...
  const handleDelete = async (id) => {
    ...
    axios
      .delete(`http://localhost:5000/api/kategori-pelatihan/${id}`)
      .then((response) => {
        fetchKategoriPelatihan();
